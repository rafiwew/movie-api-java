...
import com.example.movieapi.utils.AppExecutor;
...
public class SearchMovieApiClient {
    ...
    private class SearchRunnable implements Runnable {
            ...
            try {
                ...
                if (response.isSuccessful()) {
                    if (response.code() == 200) {
                        ...
                        List<MovieModel> searchMovieList = new ArrayList<>(((SearchMovieResponse)response.body()).getMovies());
        ...
        private Call<SearchMovieResponse> searchMovie(String query, int page) {
