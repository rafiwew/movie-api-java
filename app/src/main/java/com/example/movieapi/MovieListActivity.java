...
import com.example.movieapi.adapters.MovieRecycleView;
import com.example.movieapi.adapters.OnMovieListener;
import com.example.movieapi.models.MovieModel;
import com.example.movieapi.viewmodels.PopularMovieListViewModel;
import com.example.movieapi.viewmodels.SearchMovieListViewModel;
...
//        // here is going to detail movie that has clicked
//        Intent intent = new Intent(this, DetailMovieActivity.class);
//        intent.putExtra("movie", recycleViewAdapter.getSelectedMovie(position));
//        startActivity(intent);
//    }
//}